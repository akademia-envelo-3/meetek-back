...
public class StandardUser extends AppUser {
    ...
    public StandardUser(Long participantId, String firstname, String lastname, String mail, String password, Role role, Set<Event> ownedEvents, Map<Event, EventResponse> eventsWithResponse, Set<Group> ownedGroups, Set<Group> joinedGroups, Set<Notification> notifications) {
